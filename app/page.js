      ...
      <div className="flex flex-col md:flex-row flex-wrap flex-grow-0 bg-white gap-10 md:gap-0  py-12  w-full md:full px-10 ">
        <div className="flex-grow    flex gap-5 flex-col sm:flex-row  md:flex-col md:w-1/3   items-center  ">
          ...
          <div className="flex flex-col items-center md:px-8 lg:px-20 gap-5">
            <p className="md:text-lg">Home Vastu Kit</p>
            <p>
        ...
        <div className="flex-grow flex gap-10 md:border-solid border-opacity-10  md:border-2 md:border-x-2 md:border-black md:border-y-0  flex-col sm:flex-row md:flex-col items-center  md:w-1/3 ">
          ...
          />
          <div className="flex flex-col items-center md:px-8 lg:px-20 gap-5">
            <p className="md:text-lg">Magestic Bull Frame​</p>
            <p>
              As per Vastu, placing a picture of a running bull in the house can
              have many benefits, including maintaining peace and happiness in
              the family, preventing unnecessary arguments and grudges between
              family members, and depicting progress in life. It is believed to
              help eliminate mental stress, financial problems, and ill health.
            </p>
          </div>
        </div>
        <div className="flex-grow flex gap-5 flex-col sm:flex-row md:flex-col  items-center  md:w-1/3 ">
          ...
          />
          <div className="flex flex-col items-center md:px-8 lg:px-20 gap-5">
            <p className="md:text-lg">7 Horses Frame​</p>
            <p className="">
              7 horses represent success and power; thus, this painting brings
              energy, success in one’s life, wins in their profession, strength,
              and prosperity. The picture of seven horses brings positivity to a
              person’s life and removes negative energy. It forms a balance of
              power in one’s house, and the seven horses represent progress and
              success.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col z-20 relative justify-center items-center gap-10">
          ...
          <div className="md:px-20 text-white opacity-85 text-center">
            <p>
              ...
              30% discount offer won’t last forever, so act quickly and take the
              first step toward a more harmonious and prosperous life. 
            </p>
          </div>
          <div>
          <button className="bg-orange-200 px-8 py-4 uppercase font-semibold text-amber-700">
